...
bool detect_jab(ICM_20948_SPI *sensor, float prevSensor);
bool detect_pull(ICM_20948_SPI *sensor, float prevSensor);

#else
void printScaledAGMT(ICM_20948_I2C *sensor);
bool detect_jab(ICM_20948_I2C *sensor, float prevSensor);
...
void loop()
{
  ...
  if (myICM.dataReady())
  {
    ...
    if (detect_jab(&myICM, prevAccelX))
    {
      SERIAL_PORT.println("JAB DETECTED");
    }
